  ...
  const sendEmail = (event) => {
    ...
    emailjs
      ...
      .catch(() => {
        setIsLoading(false)
        toast.error(
          'Something went wrong. Email me directly at naveedilyas115@gmail.com',
          {
            position: 'top-right',
            autoClose: 6000,
            theme: 'colored',
  ...
  return (
    ...
    >
      ...
      <div className='contact__container grid'>
        <div className='contact__data glass-panel'>
          <span className='home__badge contact__badge'>
            Usually replies within 24 hours
          </span>
          <h3 className='contact__title'>Let&apos;s work together</h3>
          <p className='contact__description'>
            Send a note about the role, product, or collaboration. I am
            especially interested in production frontend work with TypeScript,
            React, and Next.js.
          </p>
            ...
            <div className='contact__success' role='status' aria-live='polite'>
              <div className='contact__success-mark' aria-hidden='true'>
                ...
                <svg className='contact__success-check' viewBox='0 0 52 52'>
                  <circle
                    className='contact__success-circle'
                    cx='26'
                    cy='26'
                    r='23'
                    fill='none'
                  />
                  <path
                    className='contact__success-tick'
                    fill='none'
                    d='M15.5 27.2l7.2 7.3 13.8-14.8'
                  />
                </svg>
              </div>
              <h3 className='contact__success-title'>Message Sent!</h3>
              <p className='contact__success-text'>
                Thank you for submitting your request. I appreciate you reaching
